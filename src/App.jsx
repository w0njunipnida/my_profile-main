...
const myProjects = [
  ...
  },
  {
    ...
    description:"Three.js 기반 3D 공중전 시뮬레이션. 복잡한 비행 물리 로직을 구현하고 Firebase / Capacitor로 웹·앱 동시 배포까지 완성한 단독 프로젝트입니다.",
  ...
  },
  {
    ...
    description:"Samsung Brity RPA + Python(Pandas)로 구축한 회계 자동화 시스템. 반복 업무를 제거하고 처리 효율을 극대화한 기업형 솔루션입니다.",
  ...
  },
  {
    ...
    description:"Spring Boot + MyBatis 기반 기업형 물류 관리 ERP. FastAPI + Python으로 재무 분석 엔진을 구축하고, Scikit-learn·Statsmodels Holt-Winters로 90일·12개월 AI 매출 예측을 구현했습니다.",
